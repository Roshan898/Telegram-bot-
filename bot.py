...
# Bot Configuration - Only token from environment
...
WALLETS = {
    "USDT": {
        "TRC20": "TXJgC8AMDWifSho1jRZAurWSprLEYsFMtP",
        "ERC20": "not unavailable ", 
        "BEP20": "unavailable ",
        "Polygon": "0x334A76871A0FaA559B1b2183679C4A00cd728557"
    },
    "BTC": {
        "BTC": "bc1qrx7r8d6y9yrz5694uu7qxpthqfgjz848c5c9zg"
    },
    "ETH": {
        "ETH": "0x334a76871a0faa559b1b2183679c4a00cd728557"
    }
}
...
class CryptoSwapBot:
    ...
    def create_temp_order(self, user_id, crypto_type, crypto_amount, payment_method, payment_details, blockchain):
        ...
        inr_amount = self.calculate_inr_amount(crypto_type, crypto_amount)
        
        # Calculate fees (1% + ₹10)
        fee = (inr_amount * 0.01) + 10
        net_amount = inr_amount - fee
...
• Contact Support: @your_support_handle
...
1. Send exactly **{crypto_amount} {crypto_type}** to:
...
Please contact support @your_support_handle for more information.
